...
function App() {
  ...
  const HomePage = () => (
    <>
      {/* Hero Section - Clean & Creative */}
      <section className="hero">
        <div className="hero-container">
          <div className="hero-content">
            <h1 className="hero-title">
              Build AI tools that<br />
              <span className="title-highlight">empower ordinary people</span>
            </h1>
            <p className="hero-subtitle">
              Hortus is building the Consumer Reports for AI - helping organizations compare, evaluate, and adopt AI tools that serve their communities effectively.
            </p>
            <div className="hero-buttons">
              <button onClick={() => setCurrentPage('platform')} className="demo-button">
                <span className="button-icon">▶️</span>
                Live Demo
              </button>
              <button onClick={() => setCurrentPage('whitepaper')} className="learn-button">
                Learn More
              </button>
            </div>
          </div>
          <div className="hero-visual">
            <div className="hero-image-placeholder">
              <div className="placeholder-content">
                ...
                <p>Your hero image/illustration will go here</p>
              </div>
            </div>
          </div>
        </div>
